...
from backend.routers.signals import ScanRequest, scan_best
...
async def scan_tick(bot: Bot) -> dict:
    ...
    # Resolve expired signals first. This service is transactionally isolated so
    # one broker/history failure cannot terminate the scanner run.
